...
contract Binary_Forex_Chain_6 is Context, ReentrancyGuard {
    ...
    function Calculating_Rewards_In_24_Hours() public {
        ...
        for (uint256 i = 0; i < _usersAddresses.length; i++) {
            address currentUser = _usersAddresses[i];
            uint256 currentUserLeftNode = _users[currentUser].numberOfChildNodeOnLeftForOneDay;
            uint256 currentUserRightNode = _users[currentUser].numberOfChildNodeOnRightForOneDay;
