...
contract Forex_Training1 is Context, ReentrancyGuard {
    ...
    function Calculating_Rewards_In_24_Hours() public {
        require(block.timestamp > lastRun + 5 minutes, "The Calculating_Node_Rewards_In_24_Hours Time Has Not Come");
        ...
        for (uint256 i = 0; i < _usersAddresses.length; i++) {
            ...
            uint256 leftCount = _users[currentUser].numberOfChildNodeOnLeftForOneDay + remainingUserLeftChildYesterday;
            uint256 rightCount = _users[currentUser].numberOfChildNodeOnRightForOneDay + remainingUserRightChildYesterday;
        ...
        for (uint256 i = 0; i < _usersAddresses.length; i++) {
            ...
            if (currentUser == owner) {
                ...
                currentUserBalanced = min(
                    _users[currentUser].numberOfChildNodeOnLeftForOneDay + remainingUserLeftChildYesterday,
                    _users[currentUser].numberOfChildNodeOnRightForOneDay + remainingUserRightChildYesterday
                );
        ...
        for (uint256 i = 0; i < _usersAddresses.length; i++) {
            address currentUser = _usersAddresses[i];
            currentUserLeftNode = _users[currentUser].numberOfChildNodeOnLeftForOneDay + remainingUserLeftChildYesterday;
            currentUserRightNode = _users[currentUser].numberOfChildNodeOnRightForOneDay + remainingUserLeftChildYesterday;
